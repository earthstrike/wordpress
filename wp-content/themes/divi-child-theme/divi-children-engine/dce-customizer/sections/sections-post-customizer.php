...
/**
 * Customizer Sections for the Post Customizer panel
 *
...
/**
 * Post Customizer sections
 */

function dce_customizer_sections_post_customizer( $wp_customize ) {
...
add_action( 'customize_register', 'dce_customizer_sections_post_customizer' );
