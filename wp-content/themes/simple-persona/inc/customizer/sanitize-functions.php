<?php
/**
 * Simple Persona Theme Options Sanitization Functions
 *
 ...
 */
function simple_persona_sanitize_select( $input, $setting ) {
 ...
 */
function simple_persona_sanitize_checkbox( $checked ) {
    // Boolean check.
 ...
 */
function simple_persona_sanitize_post( $input ) {
 ...
 */
function simple_persona_sanitize_image( $image, $setting ) {
    /*
 ...
 */
function simple_persona_sanitize_category_list( $input ) {
    if ( '' != $input ) {
        if( in_array( 0, $input ) ) {
            return '0';
        }
 ...
 *                    the setting default.
 */
function simple_persona_sanitize_number_range( $number, $setting ) {
